...
public class ViewAppointmentServiceImpl extends ServiceImpl<ViewAppointmentMapper, ViewAppointment>
    ...
    @Override
    public IPage<AppointmentVo> pageItem(Page<AppointmentVo> appointmentVoPage, AppointmentQueryVo queryVo) {
        return viewAppointmentMapper.pageItem(appointmentVoPage, queryVo);
    }
}
